...
IndexedModel CubeTriangles()
{
	Vertex vertices[] =
	{
		...
		Vertex(glm::vec3(-1, 1, -1), glm::vec2(0, 1), glm::vec3(0, 0, -1),glm::vec3(0, 0, 1)), //BLUE
		...
		Vertex(glm::vec3(-1, -1, 1), glm::vec2(0, 0), glm::vec3(0, 0, 1),glm::vec3(1, 1, 1)), // WHITE
		...
		Vertex(glm::vec3(-1, -1, 1), glm::vec2(0, 1), glm::vec3(0, -1, 0),glm::vec3(0, 1, 0)), // GREEN
		...
		Vertex(glm::vec3(-1, 1, 1), glm::vec2(1, 0), glm::vec3(0, 1, 0),glm::vec3(1, 1, 0)),   // YELLOW
		...
		Vertex(glm::vec3(-1, -1, 1), glm::vec2(0, 0), glm::vec3(-1, 0, 0),glm::vec3(1, 0, 0)),    // RED
		...
		Vertex(glm::vec3(1, -1, 1), glm::vec2(1, 1), glm::vec3(1, 0, 0),glm::vec3(1, 0, 1)),    // PURPLE
